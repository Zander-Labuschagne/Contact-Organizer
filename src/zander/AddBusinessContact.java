...
/**
 * Class used to control and handle GUI events while adding a business contact
 * @author Zander Labuschagne 23585137
 * E-Mail: zander.labuschagne@protonmail.ch
 */

public class AddBusinessContact implements Initializable
{
    private Stage currentStage;
    @FXML TextField txtName;
    @FXML TextField txtDayNo;
    @FXML TextField txtFaxNo;
    ...
    protected void btnAddBusinessContact_Clicked(ActionEvent event)
    {
        try
        {
            Organizer.contactList.add(new BusinessContact(txtName.getText(), txtDayNo.getText(), txtFaxNo.getText(), txtEMail.getText(), txtAddress.getText(), txtCompany.getText(), txtPosition.getText()));
